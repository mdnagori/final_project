  ...
  return (
    <div>
      <footer class="footer mt-auto  bg-light">
        <div class="container1" Style="text-align: center; background-color: #0499f0;">
          <span class="text-muted">@Air-Visca-Let's Fly Together 2022 All Rights Reserved</span>
        </div>
  </footer>
...
{/*<CDBFooter className="shadow">
      ...
      >
        ...
        <CDBBox>
          <small className="ml-2">&copy; Air Visca, 2022. All rights reserved.</small>
        </CDBBox>
        <CDBBox display="flex">
